# -*- coding: utf-8 -*-
#
# Template file provided by the aiida-gudhi; modify
...
release = aiida_gudhi.__version__
...
html_use_opensearch = 'http://aiida-gudhi.readthedocs.io'
...
htmlhelp_basename = 'aiida-gudhi-doc'
